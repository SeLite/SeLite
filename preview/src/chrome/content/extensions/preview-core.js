...
( function() {
     ...
     *  @param {boolean|undefined|string|Array|RegExp|function} [useURLencoding="readable"] Whether to apply URL encoding (English text stays human-readable) rather than base 64 encoding (human-unreadable). Thri-state boolean or other type:
     ...
     *  -If string "readable" (case-sensitive), then use URL encoding for text files (HTML/XML, JS, CSS); the shortest of URL encoding and base64 encoding for the rest
     ...
     * */
    Selenium.prototype.encodeFile= function encodeFile( url, useURLencoding="readable", contentHandler=undefined, data=undefined, dataPlaceholder=undefined ) {
     ...
     * @param {boolean|undefined|string|Array|RegExp|function} [useURLencoding="readable"] See Selenium.prototype.encodeFile().
     ...
     * */
    Selenium.prototype.encodeFileWithHandler= function encodeFileWithHandler( filePathOrURL, useURLencoding="readable", fetchFilter=undefined, handler=undefined, data=undefined, dataPlaceholder=undefined ) {
    ...
    Selenium.prototype.encodeFileRecursively= function encodeFileRecursively( filePathOrURL, useURLencoding="readable", fetchFilter=undefined, data=undefined, dataPlaceholder=undefined ) {
    ...
    */
    Selenium.encodeContent= function encodeContent( content, mime, contentIsBinary=false, useURLencoding="readable" ) {
        ...
        var useShortestEncoding= useURLencoding==='shortest' || useURLencoding==="readable" && contentIsBinary;
        if( useURLencoding==="readable" && !contentIsBinary ) {
            useURLencoding= true;
        }
        var doURLencoding;
